...
<x-page-layout>
        ...
        <div class="wrapper py-16">
            ...
            <div class="grid gird-cols-1 lg:grid-cols-2 mt-16 gap-8 items-center">
                <div class="grid grid-cols-2 lg:grid-cols-3 items-center text-center gap-4">
                    <span class="font-bold text-8xl text-slate-800">{{ $settings['facts'][$locale][0]['number'] }}</span>
                    <span class="font-bold text-4xl text-slate-800 text-start">{{ $settings['facts'][$locale][0]['title'] }}</span>
                    <span class="hidden lg:block text-7xl text-primary">|</span>
                </div>
                <div class="grid grid-cols-2 items-center gap-4">
                    <div class="flex flex-col justify-center gap-4 text-center">
                        <span class="font-bold text-5xl text-slate-800">{{ $settings['facts'][$locale][1]['number'] }}</span>
                        <span class="font-bold text-xl text-slate-800">{{ $settings['facts'][$locale][1]['title'] }}</span>
                    </div>
                    <div class="flex flex-col justify-center gap-4 text-center">
                        <span class="font-bold text-5xl text-slate-800">{{ $settings['facts'][$locale][2]['number'] }}</span>
                        <span class="font-bold text-xl text-slate-800">{{ $settings['facts'][$locale][2]['title'] }}</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="flex flex-col px-6 py-4 gap-4">
                                    ...
                                    <p class="font-bold text-slate-800 text-3xl">{{ $settings['vision_title'][$locale] }}</p>
                                    <p>
                            ...
                            <div class="swiper-slide">
                                <div class="flex flex-col px-6 py-4 gap-4">
                                    ...
                                    <p class="font-bold text-slate-800 text-3xl">{{ $settings['mission_title'][$locale] }}</p>
                            ...
                            <div class="swiper-slide">
                                <div class="flex flex-col px-6 py-4 gap-4">
                                    ...
                                    <p class="font-bold text-slate-800 text-3xl">{{ $settings['values_title'][$locale] }}</p>
            ...
            <div class="flex flex-wrap justify-center gap-6 sm:gap-12 lg:gap-18 mt-12">
                @foreach ($settings['partners'] as $partner)
                    <div class="h-12 sm:h-16 lg:h-48 border border-gray-300 rounded-lg overflow-hidden border-dashed">
                        <img class="h-full w-full object-contain object-center" src="{{ asset('storage/' . $partner) }}"
                            alt="">    
                    </div>                        
                @endforeach
            </div>
    ...
    <section id="timeline-section" class="bg-slate-50 py-24">
        <div class="wrapper flex flex-col gap-12">
            ...
            <div class="grid grid-cols-4 gap-0 items-start mt-8">
